...
void TestPlus()
{
  ...
  TimeCode tc2 = TimeCode(3, 12, 40);
  TimeCode ans = (tc + tc2);
  assert(ans.GetTimeCodeAsSeconds() == (TimeCode::ComponentsToSeconds(5, 2, 18) + TimeCode::ComponentsToSeconds(3, 12, 40)));
  cout << "PASSED!" << endl << endl;
}
...
void TestMultiply()
{
  ...
  TimeCode tc = TimeCode(5, 2, 18);
  double temp = 5;
  TimeCode ans = (tc * temp);
  assert(ans.GetTimeCodeAsSeconds() == (TimeCode::ComponentsToSeconds(5, 2, 18) * temp));
  cout << "PASSED!" << endl << endl;
}
...
void TestDivide()
{
  ...
  double temp = 5;
  TimeCode ans = (tc / temp);
  assert(ans.GetTimeCodeAsSeconds() == 3627);
  cout << "PASSED!" << endl << endl;
}
